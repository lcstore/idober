					...
					<div class="row">
						<div class="index-hot panel panel-default">
							<div class="panel-body">
								...
								<div class="col-md-3">
									<img alt="无缝沟通"
										src="https://dn-wtbox.qbox.me/img/index/i2.png?ver=3.2.26">
									<br>
									<h4>无缝沟通</h4>
									简单好用的在线讨论，无处不在的<br> 关注和评论，与团队成员之间无缝沟通
								</div>
								<div class="col-md-3">
									<img alt="资源共享"
									...
									<br>
									<h4>资源共享</h4>
									无共享，不协同，完善的文件共享<br> 让你的团队达到真正意义上的协同
								</div>
								<div class="col-md-3">
									<img alt="帮助记录"
										src="https://dn-wtbox.qbox.me/img/index/i4.png?ver=3.2.26">
									<br>
									<h4>帮助记录</h4>
									强大的在线文档编辑，帮助团队<br> 记录，积累沉淀形成团队知识库
								</div>
							</div>
						</div>
					</div>
