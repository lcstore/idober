...
//                }
    ...
    UM.registerWidget('eximage', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>eximage.css\">" +
            '<iframe id="edui152_iframe" class="%%-iframe" src="/assets/umeditor/dialogs/eximage/eximage.html" width="100%" height="100%" frameborder="0"></iframe>',
